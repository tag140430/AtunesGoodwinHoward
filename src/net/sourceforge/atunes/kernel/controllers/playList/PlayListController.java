...
public class PlayListController extends PanelController implements PlayListColumnClickedListener {
	...
	public void adjustColumnsWidth() {
		...
		int nonDurationWidth = tableWidth - favoriteColumnWidth - trackColumnWidth - durationColumnWidth;  //commented out duration
		int nonDurationColumns = table.getColumnCount() - 2 - (showGenre ? 1 : 0) - (showDuration ? 1 : 0);
